...
* See if you can find the following information on the detail page
   * Name of the task queue (done)
   * Start time (done)
   * Close time (this is the time of completion) (done)
   * Input and output for this Workflow execution (hint: click the `</> Input and Results` section) (done)
